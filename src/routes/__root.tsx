...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MiProjet+ — Gestion & finançabilité pour PME africaines" },
      { property: "og:description", content: "Structurez votre activité, bâtissez votre crédibilité financière et accédez au financement." },
